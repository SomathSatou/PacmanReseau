...
/**
 * Classe ViewCommande sert à implémenter l'interface graphique du panneau de
 * contrôle du jeu
 */
public class ViewCommande extends JFrame implements View {
    ...
    public ViewCommande( Game game ) {
        ...
        sliderTime.addChangeListener( new ChangeListener() {
            ...
            public void stateChanged( ChangeEvent arg0 ) {
                ...
                gameController.setTime( 1000 / sliderTime.getValue() );
            }
        } );
    ...
    public void update() {
        ...
        if ( game instanceof PacmanGame && ( (PacmanGame) game ).winner() != Winner.NOWINNER ) {
            btnRun.setEnabled( true );
            btnPause.setEnabled( false );
            btnStep.setEnabled( false );
            btnRestart.setEnabled( false );
