...
/**
 * PacmanGame est la classe principale du jeu Elle permet de créer la carte, de
 * compter le score, compter le nombre de vie des pacmans de nourritures, les
 * différents scores et agents ainsi que leur position
 */

public class PacmanGame extends Game {
    public enum Mode {
        AUTO, ONEPLAYER, TWOPLAYERC, TWOPLAYERO
    }
    ...
    public enum StrategyGhost {
        ASTAR, TRACKING, RANDOM, BASIC, NONE
    }

    public enum Winner {
        NOWINNER, GHOSTWINNER, PACMANWINNER
    }
    ...
    /**
     * Fonction prenant le cas où les fantômes sont effrayés s'ils sont
     * vulnérables
     */
    ...
    public void movePacmanPlayer1( Dir dir ) {
        /**
         * ajouter le protocol réseau ici
         */
    ...
    public void movePacmanPlayer2( Dir dir ) {
        /**
         * ajouter le protocol réseau ici aussi
         */
        Agent p2 = null;
    ...
    public void moveAgent( Agent agent ) {
        /**
         * protocole réseau plus en profondeur dans la pile d'éxécution
         */
    ...
    /**
     * Fonction lifeAgents permet de réduire le nombre de vie des Agents
     * Pacmans, jusqu'à la fin de la partie
     */
    ...
    /**
     * Fonction deadAgents teste pour chaque agent concerné s'il est mort et
     * change son état en conséquence
     */
